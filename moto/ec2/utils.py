...
EC2_RESOURCE_TO_PREFIX = {
    ...
    "subnet": "subnet",
    "subnet-cidr-association-id": "subnet-cidr-assoc",
    "reservation": "r",
    "volume": "vol",
    "vpc": "vpc",
...
def random_subnet_cidr_association_id():
    return random_id(prefix=EC2_RESOURCE_TO_PREFIX["subnet-cidr-association-id"])
